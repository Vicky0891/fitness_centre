...
<h1>All orders with status <c:out value="${requestScope.status.toString().toLowerCase()}"/></h1>
<table>
...
<tr><th>#</th><th>Date of order</th><th>Order details</th><th>Total cost</th><th>Client id</th><th>Feedback</th></tr>
